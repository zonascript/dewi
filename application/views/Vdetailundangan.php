...
<!--<form action="<?php echo base_url();?>index.php/Cletter/select">
 ...
 <option value="bronze">Bronze</option>
	...
	<p>Deskripsi : <div style="color:#B8A395;padding-left:10px"> <?php echo $tuk->dskripsi?></div></p>
	<p>Harga Gedung : <b>Rp <?php echo 'Rp. '.strrev(implode('.',str_split(strrev(strval($tuk->harga)),3)));?></b></h3>
