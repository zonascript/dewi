...
<!--<div class="header_bottom">
 ...
 <a href="<?php echo base_url()?>index.php/Cletter/listing"><input type="button" value="All"/></a> 
</div>
 <div id="gold" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cletter/gold"><input type="button" value="Gold"/></a> 
</div>
 <div id="silver" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cletter/silver"><input type="button" value="Silver"/></a> 
</div>
 <div id="perunggu" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cletter/Bronze"><input type="button" value="Bronze"/></a> 
</div>		    
	 <div class="content_bottom">	<ul class="products">
	 <?php foreach($Cletter as $tuk) {?>	
	 <li>
	...
	<p><h2><?php echo $tuk->nama?></h2></p>
		...
		<span><a href="<?php echo base_url()?>index.php/Cletter/detail/<?php echo $tuk->idundangan?>">Lihat Detail</a></span>
	</fieldset>
	</li>
	<?php } ?>
	</ul></div>
	  ...
	  <!--<div class="content_bottom">			
				<div class="box" style="margin-left:300px;width:500px">
					...
					<p>Kami memberikan Gedung sesuai akan budget yang anda punya</p>
				          <div class="more">
				         	  	<span><a href="<?php echo base_url();?>index.php/Cvenue/listing">Lihat Gedung</a></span>
				         	  </div>
				</div>-->
