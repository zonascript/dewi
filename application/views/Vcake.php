...
<!--<div class="header_bottom">
 ...
 <a href="<?php echo base_url()?>index.php/Ccake/listing"><input type="button" value="All"/></a> 
</div>
 <div id="gold" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Ccake/gold"><input type="button" value="Gold"/></a> 
</div>
 <div id="silver" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Ccake/silver"><input type="button" value="Silver"/></a> 
</div>
 <div id="perunggu" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Ccake/Bronze"><input type="button" value="Bronze"/></a> 
</div>	    
	 <div class="content_bottom">
	 	<ul class="products" style="width:900px;min-height:300px;margin-left:80px;"> <?php foreach($Ccake as $tuk) {?>		
	...
	<p><h2><?php echo $tuk->nama?></h2></p>
		...
		<span><a href="<?php echo base_url()?>index.php/Ccake/detail/<?php echo $tuk->idkatering?>">Lihat Detail</a></span>
	</fieldset>
	</li>
	<?php } ?>
	</ul></div>
