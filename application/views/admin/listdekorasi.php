...
<td><?php echo $nomor++; ?></td>
 ...
 <td><img src="<?php echo base_url();?>uploads/<?php echo $tuk->photo==""?"noprofile.jpg":$tuk->photo ?>" height=50 width=50 /></td>
    <td><a href="<?php echo base_url()?>index.php/admin/dekorasi/edit/<?php echo $tuk->iddekorasi?>">Edit</a></td>
    <td><a href="<?php echo base_url()?>index.php/admin/dekorasi/delete/<?php echo $tuk->iddekorasi?>">Delete</a></td>
</tr>
<?php } ?>
