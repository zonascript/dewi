...
float: right;
font-size: 16px;"><a href="<?php echo base_url();?>index.php/admin/undangan/logout">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
...
<td><?php echo $nomor++; ?></td>
  ...
  <td><?php echo $tuk->jenis?></td>
    ...
    <td><?php echo $tuk->harga?></td>
	 <td><?php echo $tuk->dskripsi?></td>
 <td><img src="<?php echo base_url();?>uploads/<?php echo $tuk->photo==""?"noprofile.jpg":$tuk->photo ?>" height=50 width=50 /></td>
    <td><a href="<?php echo base_url()?>index.php/admin/undangan/edit/<?php echo $tuk->idundangan?>">Edit</a></td>
    <td><a href="<?php echo base_url()?>index.php/admin/undangan/delete/<?php echo $tuk->idundangan?>">Delete</a></td>
</tr>
<?php }?>
