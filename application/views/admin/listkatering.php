            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                      <div> <a href="<?php echo base_url()?>index.php/admin/katering/tambah/">Add New</a></div>
...
<td><?php echo $nomor++; ?></td>
  ...
  <td><?php echo $tuk->jenis?></td>
	...
	<td><?php echo $tuk->deskripsi?></td>
 <td><img src="<?php echo base_url();?>uploads/<?php echo $tuk->photo==""?"noprofile.jpg":$tuk->photo ?>" height=50 width=50 /></td>
    <td><a href="<?php echo base_url()?>index.php/admin/katering/edit/<?php echo $tuk->idkatering?>">Edit</a></td>
    <td><a href="<?php echo base_url()?>index.php/admin/katering/delete/<?php echo $tuk->idkatering?>">Delete</a></td>
</tr>
<?php } ?>
