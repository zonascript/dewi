            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                      <div> <a href="<?php echo base_url()?>index.php/admin/salon/tambah/">Add New</a></div>
...
<td><?php echo $nomor++; ?></td>
 ...
 <td><img src="<?php echo base_url();?>uploads/<?php echo $tuk->photo==""?"noprofile.jpg":$tuk->photo ?>" height=50 width=50 /></td>
    <td><a href="<?php echo base_url()?>index.php/admin/salon/edit/<?php echo $tuk->idsalon?>">Edit</a></td>
    <td><a href="<?php echo base_url()?>index.php/admin/salon/delete/<?php echo $tuk->idsalon?>">Delete</a></td>
</tr>
<?php } ?>
