...
<body>
    <div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form method="post"id="validasi" name="daftar" onsubmit="return validasi()" action="<?php echo base_url();?>index.php/admin/pemesanan/simpans" enctype="multipart/form-data">
            <fieldset>
        ...
        <!-- <div>
                ...
                <div>
                  <input type="text" name="status" value="<?php echo $status?>"  placeholder="status"/>
                </div>
