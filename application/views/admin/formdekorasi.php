...
if (isset($dekorasi)) {
  ...
  $id=$dekorasi->iddekorasi;
    $nama=$dekorasi->nama;
        $alamat=$dekorasi->alamat;

    $jenis=$dekorasi->jenis;
  $cp=$dekorasi->cp;
  $harga=$dekorasi->harga;
  $deskripsi=$dekorasi->deskripsi;
  $photo=$dekorasi->photo;
...
font-size: 16px;"> <a href="<?php echo base_url();?>index.php/admin/pemesanan/logout">Logout</a> </div>
                      ...
                      <div> <a href="<?php echo base_url()?>index.php/admin/dekorasi/tambah/">Add New</a></div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form method="post"id="validasi" name="daftar" onsubmit="return validasi()" action="<?php echo base_url();?>index.php/admin/dekorasi/simpan" enctype="multipart/form-data">
            <fieldset>
                <legend>Form Dekorasi</legend>
        <!-- <div>
        ...
        <input type="number" name="harga" maxlength="8" id="harga"  value="<?php echo $harga?>" placeholder="Harga"/>
               ...
               <div>
      <textarea name="deskripsi" id="deskripsi" rows="4" cols="20" value="<?php echo $deskripsi?>"></textarea>
                </div>
         <div >
                      <td>Photo</td>
                      <td>
                ...
                <input type="submit" value="Simpan"/>
                            ...
                            <?php 
  if($id!="")
  echo "<input type='hidden' value='$id' name='iddekorasi'>";
