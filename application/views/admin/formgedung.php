...
font-size: 16px;"> <a href="<?php echo base_url();?>index.php/admin/pemesanan/logout">Logout</a> </div>
                      ...
                      <div> <a href="<?php echo base_url()?>index.php/admin/dekorasi/tambah/">Add New</a></div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form method="post"id="validasi" name="daftar" onsubmit="return validasi()" action="<?php echo base_url();?>index.php/admin/gedung/simpan" enctype="multipart/form-data">
            <fieldset>
                <legend>Form Gedung</legend>
        <!-- <div>
        ...
        <div>
                ...
                <div>
                 <input type="number" name="kapasitas"  id="kapasitas" value="<?php echo $kapasitas?>" placeholder="Kapasitas"/>
                </div>
        <div>
                  <div>
        <input type="number" name="harga" maxlength="8" id="harga"  value="<?php echo $harga?>" placeholder="Harga"/>
         ...
         <div >
                ...
                <input type="submit" value="Simpan"/>
                            ...
                            <?php 
  if($id!="")
  echo "<input type='hidden' value='$id' name='idgedung'>";
?>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
