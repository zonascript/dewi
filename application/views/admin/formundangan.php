...
if (isset($undangan)) {
  ...
  $id=$undangan->idundangan;
    $nama=$undangan->nama;
        $alamat=$undangan->alamat;

    $jenis=$undangan->jenis;
  $cp=$undangan->cp;
  $harga=$undangan->harga;
  $deskripsi=$undangan->dskripsi;
  $photo=$undangan->photo;
...
font-size: 16px;"> <a href="<?php echo base_url();?>index.php/admin/pemesanan/logout">Logout</a> </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                      <div> <a href="<?php echo base_url()?>index.php/admin/undangan/tambah/">Add New</a></div>
                        <div class="panel-heading">
                             Daftar Undangan
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form method="post"id="validasi" name="daftar" onsubmit="return validasi()" action="<?php echo base_url();?>index.php/admin/undangan/simpan" enctype="multipart/form-data">
            <fieldset>
                <legend>Form Undangan</legend>
        ...
        <input type="number" name="harga" maxlength="8" id="harga"  value="<?php echo $harga?>" placeholder="Harga"/>
				...
				<div>
      <textarea name="dskripsi" id="deskripsi" rows="4" cols="20" value="<?php echo $deskripsi?>"></textarea>
                </div>
         ...
         <div >
                ...
                <input type="submit" value="Simpan"/>
                             ...
                             <?php 
  if($id!="")
  echo "<input type='hidden' value='$id' name='idundangan'>";
  echo "<input type='hidden' value='$photo' name='photo'>";
?>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
