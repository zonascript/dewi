  ...
  <!-- BOOTSTRAP STYLES-->
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    function validasi() {
          ...
          var deskripsi=document.getElementaryById('deskripsi');
                      ...
                      <div> <a href="<?php echo base_url()?>index.php/admin/dekorasi/tambah/">Add New</a></div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               <form method="post"id="validasi" name="daftar" onsubmit="return validasi()" action="<?php echo base_url();?>index.php/admin/salon/simpan" enctype="multipart/form-data">
            <fieldset>
                <legend>Form Salon</legend>
        <!-- <div>
      ...
      <textarea name="deskripsi" id="deskripsi" rows="4" cols="20" value="<?php echo $deskripsi?>"></textarea>
         ...
         <div >
                ...
                <input type="submit" value="Simpan"/>
                            ...
                            <?php 
  if($id!="")
  echo "<input type='hidden' value='$id' name='idsalon'>";
