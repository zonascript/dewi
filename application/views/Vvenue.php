...
<!--<div class="header_bottom">
 ...
 <a href="<?php echo base_url()?>index.php/Cvenue/listing"><input type="button" value="All"/></a> 
</div>
 <div id="gold" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cvenue/gold"><input type="button" value="Gold"/></a> 
</div>
 <div id="silver" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cvenue/silver"><input type="button" value="Silver"/></a> 
</div>
 <div id="perunggu" style="float:left;margin-left:10px;">
 <a href="<?php echo base_url()?>index.php/Cvenue/bronze"><input type="button" value="Bronze"/></a> 
</div>		    
		 <div class="content_bottom">	<ul class="products"> <?php foreach($Cvenue as $tuk) {?>			
			  <li>
	...
	<p><h2><?php echo $tuk->nama?></h2></p>
			...
			<span><a href="<?php echo base_url()?>index.php/Cvenue/detail/<?php echo $tuk->iddekorasi?>">Lihat Detail</a></span>
